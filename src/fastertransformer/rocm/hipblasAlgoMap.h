...
public:
    ...
    bool isExist(const int batch_count, const int m, const int n, const int k, const HipblasDataType data_type);

    hipblasLtMatmulAlgo_info
    getAlgo(const int batch_count, const int m, const int n, const int k, const HipblasDataType data_type);
};
