...
hipblasOperation_t opConvert(TransposeOperation op) {
    switch (op) {
        case TransposeOperation::NONE: return hipblasOperation_t::HIPBLAS_OP_N;
        case TransposeOperation::TRANSPOSE: return hipblasOperation_t::HIPBLAS_OP_T;
...
hipblasDatatype_t dtypeConvert(DataType dtype) {
    switch (dtype) {
        case DataType::TYPE_FP16 : return hipblasDatatype_t::HIPBLAS_R_16F;
        case DataType::TYPE_FP32 : return hipblasDatatype_t::HIPBLAS_R_32F;
        default: throw OpException(OpErrorType::ERROR_UNIMPLEMENTED);
    }
};
